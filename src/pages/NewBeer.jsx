...
export default function NewBeer() {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="tagline" onChange={handleInput} /><br />
                
                <label htmlFor="description">Description: </label><br />
                <input type="text"  name="description" onChange={handleInput} /><br />
                
                <label htmlFor="first_brewed">First Brewed:</label><br />
                <input type="text"  name="first_brewed" onChange={handleInput} /><br />
                
                <label htmlFor="brewers_tips">Brewers Tips:</label><br />
                <input type="text"  name="brewers_tips" onChange={handleInput} /><br />
                
                <label htmlFor="attenuation_level ">Attenuation Level:</label><br />
                <input type="number"  name="attenuation_level" onChange={handleInput} /><br />
                
                <label htmlFor="contributed_by ">Contributed By:</label><br />
                <input type="text"  name="contributed_by" onChange={handleInput} /> <br />
